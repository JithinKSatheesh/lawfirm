        ...
        <>
            <div className="footer_container">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col  col-12 col-lg-6 text-center text-white font-weight-bold text-md-left mobile-no-display">
                            {/* <img className="nav-logo" src={logo} alt="" /> */}
                            TRADE IMPRESSIO
                        </div>
                        <div className="col col-12 col-lg-6">
                        <Scrollspy items={ ['about', 'contact', 'service'] } currentClassName="is-current">
                            <div className="text-white  font-wight-bold h5 text-lg-right text-center">
